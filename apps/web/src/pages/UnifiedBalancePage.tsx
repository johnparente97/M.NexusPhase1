...
import { SUPPORTED_CHAINS, SupportedToken, MERIDIAN_TOP_UP_FEE_BPS } from '../config/chain-config';
...
export default function UnifiedBalancePage() {
  ...
  const handleExecuteTopUp = () => {
    ...
    setTimeout(() => {
      ...
      toast(`Successfully credited $${calculation.netCreditedUsdc.toFixed(2)} USDC to your Unified AI Balance!`, 'success');
    }, 1200);
  };
    ...
    <div className="flex-1 flex flex-col max-w-5xl mx-auto w-full px-4 sm:px-6 py-6 gap-8 select-none pb-20">
      ...
      <div className="flex flex-col gap-1.5 border-b border-zinc-900 pb-6">
        ...
        <p className="text-xs text-zinc-400 max-w-2xl leading-relaxed">
          Fund your AI balance using supported EVM tokens. Paid automatically via Meridian settlement infrastructure.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-zinc-900 border-zinc-800 p-5 flex flex-col gap-2">
          <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Meridian Cashback</span>
          <span className="text-2xl font-display font-bold text-emerald-400">
            +0.428 MRDN
          </span>
          <span className="text-[10px] text-zinc-500 font-mono">2% Base Sepolia Reward</span>
        </Card>
      </div>
      ...
      <Card className="bg-zinc-900 border-zinc-800 p-6 flex flex-col gap-6 shadow-xl">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
          ...
          <span className="text-[10px] font-mono text-zinc-500">
            Meridian Fee: 1% ({MERIDIAN_TOP_UP_FEE_BPS} BPS)
          </span>
        </div>
        ...
        {/* 1% Meridian Fee & Conversion Breakdown Box */}
        <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-4.5 flex flex-col gap-2.5 text-xs font-mono">
          ...
          <div className="flex justify-between text-zinc-400 border-b border-zinc-900 pb-2">
            <span>1% Meridian Top-Up Fee:</span>
            <span className="text-amber-400 font-semibold">-${calculation.meridianTopUpFeeUsd.toFixed(2)}</span>
          </div>
          <div className="flex justify-between text-zinc-400 border-b border-zinc-900 pb-2">
          ...
          <div className="flex justify-between text-[#27F293] font-bold text-sm pt-1">
            <span>Net Credited USDC Balance:</span>
      ...
      <div className="flex flex-col gap-4 border-t border-zinc-900 pt-6">
        ...
        >
          ...
          <span>{showAdvancedTech ? 'Hide Advanced Technical Blockchain View' : 'Show Advanced Technical Blockchain View'}</span>
        </button>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px]">
              ...
              <div className="bg-zinc-900/60 p-3 rounded-lg flex justify-between">
                ...
                <span className="text-zinc-200">USDC / USDG (EIP-3009)</span>
              </div>
            </div>
          </motion.div>
        )}
