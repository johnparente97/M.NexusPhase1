...
// Multi-model adapter for unmetered, free open-weights LLMs on Nexus.
  ...
  static async *streamCompletion(
    ...
    try {
      ...
      if (selectedModel.id === 'deepseek-r1-free') {
        ...
        reply = `⚡ **Mistral 7B (Fast Output)**: Quick, concise response generated in sub-100ms latency.\n\nNexus provides free access to open-weights models including Mistral, Dolphin, DeepSeek R1, Llama 3.3, and Qwen 2.5. You can switch models anytime using the top dropdown selector!`;
      } else {
