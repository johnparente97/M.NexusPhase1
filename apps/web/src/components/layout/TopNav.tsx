...
export default function TopNav({ onSearchClick, onMobileMenuClick }: TopNavProps) {
  ...
  return (
    <header className="h-14 px-3 sm:px-5 bg-[#141416]/80 backdrop-blur-xl border-b border-zinc-800/80 flex items-center justify-between select-none shrink-0 w-full">
      ...
      {/* Desktop Left: Breadcrumb / Status Badge */}
      <div className="hidden lg:flex items-center gap-2 text-xs font-mono text-zinc-400">
        <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
          <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
          AntSeed Decentralized AI Active
        </span>
      </div>
